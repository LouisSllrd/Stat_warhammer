...
const AccueilMobile = () => {
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: 20, lineHeight: 1.7 }}>
      ...
      <p>
La connexion est nécessaire pour créer et gérer vos profils personnels. Elle permet de générer un identifiant et un mot de passe associés à une base de données que vous créez vous-même. Votre adresse e-mail n'est communiquée à personne. Le compte sert uniquement à créer un identifiant et un mot de passe pour gérer l'accès aux données, assurant ainsi que chacun ait accès à ses propres fiches d'unités.</p>
